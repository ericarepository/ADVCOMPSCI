...
public class ForestFire {
    ...
    */
    ...
    //End of citation
    /*this main method is compiling methods and
    evaluating data from an array to determine the chance of a forest fire.
    */
    ...
    /*
    This method introduces what a forest fire is, and what the program does.
     */
    ...
    // This method asks the user to input the date, so that each file write-in has a date
    ...
    /* This method asks the user to input 3 humidities, which will be averaged and
     used as a statistic in the main method.
     */
    ...
    /* This method asks the user whether or not there are frequent gusts of wind.
    The output is averaged, and used alongside the humidity averages
    to determine the chance of a forest fire in the main method.
     */
    ...
    This method writes the outputs to a file.
     */
